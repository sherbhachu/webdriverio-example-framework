...
exports.config = {
    ...
    cucumberOpts: {
        require: [
            './features/step_definitions/debug_steps.js',
            './features/step_definitions/general_steps.js',
            './features/step_definitions/navigation_steps.js',
            './features/step_definitions/product_listings_steps.js',
            './features/step_definitions/shopping_basket_steps.js',
     ...
     */
     beforeScenario: function (scenario) {
        console.log("Just logging the scenario name: "+scenario.name)
    },
    /**
